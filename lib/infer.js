...
(function(root, mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    return mod(exports, require("acorn/dist/acorn.js"), require("acorn-loose/dist/acorn-loose.js"), require("acorn-walk/dist/walk.js"),
               require("./def"), require("./signal"));
  if (typeof define == "function" && define.amd) // AMD
    return define(["exports", "acorn/dist/acorn.js", "acorn-loose/dist/acorn-loose.js", "acorn-walk/dist/walk.js", "./def", "./signal"], mod);
  mod(root.tern || (root.tern = {}), acorn, acorn.loose, acorn.walk, tern.def, tern.signal); // Plain browser env
})(this, function(exports, acorn, acorn_loose, walk, def, signal) {
  "use strict";

  var toString = exports.toString = function(type, maxDepth, parent) {
    if(type && type.name == "THIS")return "Object";
  ...
  Obj.prototype = extend(Type.prototype, {
    ...
    defProp: function(prop, originNode, propDisplay) {
